...
# Uncomment these two lines of database connection

# db_connection = mysql.connector.connect(host = "localhost", user = "sdms")# creating database_cursor to perform SQL operation  
